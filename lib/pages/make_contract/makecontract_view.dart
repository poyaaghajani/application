...
class _MakeContractState extends State<MakeContract>
  ...
  final _firstkeys = GlobalKey<FormState>();
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: getColors.dark.withOpacity(0.4),
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                if (_firstkeys.currentState!.validate()) {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    if (_secondKeys.currentState!.validate()) {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Text(
                      'سایر شرایط',
                      style: TextStyle(fontSize: 25, color: getColors.dark),
                    ),
                    SizedBox(
                      width: width / 2.5,
                      child: const Divider(thickness: 2, color: getColors.dark),
                    ),
                    SizedBox(height: height / 15),
                    const Spacer(),
                    GestureDetector(
